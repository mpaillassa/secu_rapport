...
Les seules différences entre SSLv3, TLS 1.0, TLS 1.1 et TLS 1.2 sont principalement les "versions" des algorithmes utilisés (RSA 512/1024/2048 bits, etc), mais le fonctionnement global décrit par les protocoles TLS handshake et TLS record est très similaire. \\
...
La faille Poodle exploite une faille de SSLv3 au niveau du chiffrement symétrique CBC: le padding (complétion d'un bloc de bits pour respecter un format) permet de déchiffrer des messages. \\
